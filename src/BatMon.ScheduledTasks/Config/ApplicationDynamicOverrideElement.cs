...
{
    public class ApplicationDynamicOverrideElement : ConfigurationElement
    {
        public ApplicationDynamicOverrideElement() { }
        public ApplicationDynamicOverrideElement(string Value)
        {
            this.Value = Value;
        }
